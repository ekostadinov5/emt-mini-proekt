package mk.ukim.finki.emt.cinema.sharedkernel.port.rest;

import mk.ukim.finki.emt.cinema.sharedkernel.infra.eventlog.DomainEventLogService;
...
@RestController
@RequestMapping(path = "/api/event-log")
