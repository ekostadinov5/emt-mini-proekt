...
import mk.ukim.finki.emt.cinema.moviecatalog.integration.ReservationCancelledEventLog;
...
@Service
public class ReservationCancelledRemoteEventLogServiceClient implements RemoteEventLogService {

    private final String source;
    private final RestTemplate restTemplate;

    public ReservationCancelledRemoteEventLogServiceClient(@Value("${app.user-management.url}") String source,
    ...
    private RemoteEventLog retrieveLog(@NonNull URI uri) {
        ...
        return new ReservationCancelledEventLog(response);
    }
